...
public final class HeapSorterTest {
    private final HeapSorter classUnderTest = new HeapSorter();

    @Test
    public void sort_int_array_when() {
        final List<Integer> list = new ArrayList<>(11);
        list.add(43);
        list.add(3);
        list.add(33);
        list.add(10);
        ...
        assertEquals(new Integer(543782), list.get(10));
    }
}